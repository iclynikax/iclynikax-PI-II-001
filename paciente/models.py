...
class Pet_Cliente(models.Model):
    ...
    Pet = models.ForeignKey(Pet, on_delete=models.DO_NOTHING, null=True, blank=True)
    ...
    status = models.CharField(max_length=1, choices=status_petcliente, default='A')
...
class Consulta(models.Model):
    ...
    Medico = models.ForeignKey(DadosMedico, on_delete=models.DO_NOTHING, null=True, blank=True)
...
class Notificacao(models.Model):  
    ...
    dt_envio = models.DateTimeField(default=datetime.datetime.now) #Data do Envio
